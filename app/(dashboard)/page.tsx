    ...
    return (
        <div className="h-full bg-background" >
            <div className="bg-card">
                <div className="container flex flex-wrap items-center justify-between gap-6 py-2 px-3 md:px-6">
                    ...
                    <div className="flex items-center gap-3">
                        <CreateTransactionDialog
                            trigger={
                                <button
                                    type="button"
                                    className="py-[0.4rem] px-4 rounded-md bg-green-300 hover:bg-green-500 text-gray-900 dark:bg-teal-800 dark:hover:bg-teal-600 dark:text-white transition-all duration-500 text-sm" >
                                    New Income
                                </button>
                            }
                            type="income"
                        ...
                        <CreateTransactionDialog
                            trigger={
                                <button
                                    type="button"
                                    className="py-[0.4rem] px-4 rounded-md bg-red-400 hover:bg-red-500 dark:bg-rose-500 !bg-opacity-50 hover:!bg-opacity-80 dark:text-white transition-all duration-500 text-sm" >
                                    New Expense
                                </button>
                            }
                            type="expense"
